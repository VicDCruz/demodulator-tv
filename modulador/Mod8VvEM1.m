%Este programa
%tiene al final una traslacion 
%por heterodinacion de la if al
%canal asignado para transmision (60-66MHz)canal 3 
%El limite es 1/2 de la frec. de fm=376.678295 MHz

%
%Este programa integra todo el proceso a partir
%de un flujo random de 832 valores simulando la salida
%del codificador Trellis (-7 -5 -3 -1 1 3 5 7)
%Usa el fitro Nyquist para crear la envovente continua
%que modulara en amplitud a la portadora IF a 41 MHz
